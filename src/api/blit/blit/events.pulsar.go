...
var (
	...
	fd_EventCreateTask_task_id protoreflect.FieldDescriptor
)

func init() {
	file_blit_blit_events_proto_init()
	md_EventCreateTask = File_blit_blit_events_proto.Messages().ByName("EventCreateTask")
	fd_EventCreateTask_task_id = md_EventCreateTask.Fields().ByName("task_id")
}
...
func (x *EventCreateTask) slowProtoReflect() protoreflect.Message {
	mi := &file_blit_blit_events_proto_msgTypes[0]
...
func (x *fastReflection_EventCreateTask) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TaskId != uint64(0) {
		...
		if !f(fd_EventCreateTask_task_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventCreateTask) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "blit.blit.EventCreateTask.task_id":
		return x.TaskId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blit.blit.EventCreateTask"))
		}
		panic(fmt.Errorf("message blit.blit.EventCreateTask does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventCreateTask) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message blit.blit.EventCreateTask does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventCreateTask) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "blit.blit.EventCreateTask.task_id":
		panic(fmt.Errorf("field task_id of message blit.blit.EventCreateTask is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blit.blit.EventCreateTask"))
		}
...
func (x *fastReflection_EventCreateTask) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in blit.blit.EventCreateTask", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EventCreateTask) Descriptor() ([]byte, []int) {
	return file_blit_blit_events_proto_rawDescGZIP(), []int{0}
}

func (x *EventCreateTask) GetTaskId() uint64 {
	if x != nil {
		return x.TaskId
	}
	return 0
...
var File_blit_blit_events_proto protoreflect.FileDescriptor

var file_blit_blit_events_proto_rawDesc = []byte{
	,
...
var (
	file_blit_blit_events_proto_rawDescOnce sync.Once
	file_blit_blit_events_proto_rawDescData = file_blit_blit_events_proto_rawDesc
)

func file_blit_blit_events_proto_rawDescGZIP() []byte {
	file_blit_blit_events_proto_rawDescOnce.Do(func() {
		file_blit_blit_events_proto_rawDescData = protoimpl.X.CompressGZIP(file_blit_blit_events_proto_rawDescData)
	})
	return file_blit_blit_events_proto_rawDescData
}

var file_blit_blit_events_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_blit_blit_events_proto_goTypes = []interface{}{
	(*EventCreateTask)(nil), // 0: blit.blit.EventCreateTask
}
var file_blit_blit_events_proto_depIdxs = []int32{
...
func init() { file_blit_blit_events_proto_init() }
func file_blit_blit_events_proto_init() {
	if File_blit_blit_events_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_blit_blit_events_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_blit_blit_events_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_blit_blit_events_proto_goTypes,
		DependencyIndexes: file_blit_blit_events_proto_depIdxs,
		MessageInfos:      file_blit_blit_events_proto_msgTypes,
	}.Build()
	File_blit_blit_events_proto = out.File
	file_blit_blit_events_proto_rawDesc = nil
	file_blit_blit_events_proto_goTypes = nil
	file_blit_blit_events_proto_depIdxs = nil
}
