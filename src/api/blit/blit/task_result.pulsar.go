...
var (
	...
	fd_TaskResult_index      protoreflect.FieldDescriptor
	fd_TaskResult_status     protoreflect.FieldDescriptor
	fd_TaskResult_executedOn protoreflect.FieldDescriptor
...
func init() {
	...
	fd_TaskResult_index = md_TaskResult.Fields().ByName("index")
	fd_TaskResult_status = md_TaskResult.Fields().ByName("status")
	fd_TaskResult_executedOn = md_TaskResult.Fields().ByName("executedOn")
...
func (x *fastReflection_TaskResult) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Index != "" {
		...
		if !f(fd_TaskResult_index, value) {
			return
		}
	}
	if x.Status != int32(0) {
		value := protoreflect.ValueOfInt32(x.Status)
		if !f(fd_TaskResult_status, value) {
			return
		}
	}
	if x.ExecutedOn != "" {
		value := protoreflect.ValueOfString(x.ExecutedOn)
		if !f(fd_TaskResult_executedOn, value) {
			return
		}
	}
	if x.Creator != "" {
...
func (x *fastReflection_TaskResult) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "blit.blit.TaskResult.index":
		return x.Index != ""
	case "blit.blit.TaskResult.status":
		return x.Status != int32(0)
	case "blit.blit.TaskResult.executedOn":
		return x.ExecutedOn != ""
...
func (x *fastReflection_TaskResult) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "blit.blit.TaskResult.index":
		panic(fmt.Errorf("field index of message blit.blit.TaskResult is not mutable"))
	case "blit.blit.TaskResult.status":
		panic(fmt.Errorf("field status of message blit.blit.TaskResult is not mutable"))
	case "blit.blit.TaskResult.executedOn":
		panic(fmt.Errorf("field executedOn of message blit.blit.TaskResult is not mutable"))
	case "blit.blit.TaskResult.creator":
...
func (x *TaskResult) GetIndex() string {
	if x != nil {
		return x.Index
	}
	return ""
...
var file_blit_blit_task_result_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x74, 0x2e, 0x62, 0x6c, 0x69, 0x74, 0x22, 0x74, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x64,
	0x4f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74,
	0x65, 0x64, 0x4f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x42, 0x81,
	0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x6c, 0x69, 0x74, 0x2e, 0x62, 0x6c, 0x69, 0x74,
	0x42, 0x0f, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x50, 0x72, 0x6f, 0x74,
